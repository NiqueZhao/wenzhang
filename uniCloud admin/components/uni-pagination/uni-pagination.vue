<template>
    <view class="uni-pagination">
        <view class="uni-pagination__total">
            共 {{total}} 条
        </view>
        ...
        <view class="uni-pagination__num">
            <view class="uni-pagination__num-current">
                <!-- <text class="uni-pagination__num-current-text" style="color:#007aff">{{ currentIndex }}</text><text
                    class="uni-pagination__num-current-text">/{{ maxPage || 0 }}</text>
 -->
                <view v-for="(item,index) in paper" :key="index" :class="{'page--active':item === currentIndex}" class="uni-pagination__num-tag tag--active"
